...
public class SimpleQuerying 
{
	...
	public static void main(String[] args) throws Exception 
	{
		...
		JussSerializer.JUSS_PARSERS.get(ObjectConverter.class).getInvokableClasses().addAll(Arrays.asList(JsonSerializer.class, Integer.class)); //This is necessary since 1.3.8

...
public abstract class SerializationProtocol<T>
{
	 ...
	 * @since 1.3.0
	 */
	public static final ProtocolRegistry REGISTRY = new ProtocolRegistry(new UniversalObjectInstantiationProtocol<Object>(), new ListProtocol(), new MapProtocol(), new StringProtocol(), new ScopeProtocol(), new SelfSerializableProtocol(), new EnumProtocol());

...
public class ObjectConverterOld implements DataConverter 
{
	 ...
	 * 
	 * @since 1.0.0 (moved to {@link SerializableBase64Converter} since 1.3.0 and since 1.3.5 into {@link ObjectConverterOld})
	 */
	 ...
	 * Note: This is mainly used by {@link ObjectConverterOld}!
	 *
	 * @since 1.3.5
	 */
	...
	public static Class<?> getProtocolExprClass(String str, Object[] compilerArgs)
	{
		...
		try 
		{
			Class<?> cls = ImportsProvider.forName(compilerArgs.length > 0 ? compilerArgs[0] : null, str.substring(0, i), false, ObjectConverterOld.class.getClassLoader());
			if (cls != null)
				return cls;
			for (char ch; i < len; i++)
			{
	...
	/**
	 * Used internally by {@link ObjectConverterOld}!<br>
	 ...
	 * @since 1.3.0
	 */
	public static class IsSelectorScope {};
}